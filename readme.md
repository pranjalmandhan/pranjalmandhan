...
* **Integrity:** Multi-step SQL pipeline to clean transaction logs and ensure 100% data accuracy.
* **Analytics:** Transformed raw database tables into high-level business KPIs.
